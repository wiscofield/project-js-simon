...
function playNote(note) {
  ...
  playFreqWithWaveform(freq, 'sawtooth');
}
...
$('.simon-button').on('mousedown', function() {
  ...
  playNote(colorNotes[buttonColor]);
...
$(document).on('keydown', function(event) {
  ...
  if (char === 'T') {
    playNote(colorNotes['green']);
  } else if (char === 'Y') {
    playNote(colorNotes['red']);
  } else if (char === 'G') {
    playNote(colorNotes['yellow']);
  } else if (char === 'H') {
    playNote(colorNotes['blue']);
  }
});
